...
document.addEventListener("DOMContentLoaded", function () {
    // Suara dering
    function deringTasbihCount() {
        const audioDering = new Audio('https://raw.githubusercontent.com/aflacake/tasbihcount/second/mp3/ringtone-1-46486.mp3');
        audioDering.play();
    }
        ...
        if (kutipanAcak !== kutipanTampilSebelumnya) {
            if (kutipanTransisi) {
                ...
                setTimeout(() => {
                    ...
                    kutipanTampilSebelumnya = kutipanAcak;
                }, 4000);
            }
        }
    }
